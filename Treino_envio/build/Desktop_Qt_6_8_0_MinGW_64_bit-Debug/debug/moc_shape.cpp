...
struct qt_meta_stringdata_CLASSShapeENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSShapeENDCLASS = QtMocHelpers::stringData(
    "Shape"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSShapeENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Shape::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSShapeENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSShapeENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSShapeENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *Shape::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSShapeENDCLASS.stringdata0))
